...
public class EchoClient extends JFrame {
    ...
    public void connection () throws IOException {
        ...
        new Thread(() -> {
            try {
                //цикл авторизации клиента на клиентской стороне. пока не авторизуется, другие сообщения получать не сможет
            while (true){
...
//        try {
//            dos.writeUTF("/auth " + loginField.getText() + " " + asswordField.getText());
//            loginField.setText("");
